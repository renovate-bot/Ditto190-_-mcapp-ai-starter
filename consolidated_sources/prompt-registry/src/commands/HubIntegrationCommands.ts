...
export class HubIntegrationCommands {
  ...
  constructor(
    ...
    this.syncCommands = new HubSyncCommands(
      hubManager,
      this.historyCommands.getSyncHistory(),
    );
  ...
  private registerActivationCommands(): void {
    this.context.subscriptions.push(
      ...
      vscode.commands.registerCommand(
        "promptregistry.deactivateHubProfile",
   ...
   */
  private async selectActiveProfile(): Promise<{
    hubId: string;
    profileId: string;
  } | null> {
    ...
    return selected
      ? { hubId: selected.hubId, profileId: selected.profileId }
      : null;
  }
