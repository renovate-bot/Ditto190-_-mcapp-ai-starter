...
## Dev Container / Linux Quick Bootstrap

If your environment defaults to an older Node.js version, use `nvm` to pin this repository to Node 20 before installing dependencies.
...
This repository includes a `.nvmrc` file (`20`) so `nvm install` and `nvm use` select a compatible runtime automatically.
