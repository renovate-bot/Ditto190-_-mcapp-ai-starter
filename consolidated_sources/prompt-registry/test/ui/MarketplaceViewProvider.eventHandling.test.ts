...
suite("MarketplaceViewProvider - Event Handling", () => {
  ...
  let onBundleInstalledCallback:
    | ((installation: InstalledBundle) => void)
    | undefined;
  let onBundleUninstalledCallback: ((bundleId: string) => void) | undefined;
  let onBundleUpdatedCallback:
    | ((installation: InstalledBundle) => void)
    | undefined;
  ...
  suite("Event Listener Registration", () => {
    test("should register listener for onBundleInstalled event", () => {
      ...
      assert.ok(
        onBundleInstalledCallback,
        "Should have callback for onBundleInstalled",
      );
    });
    ...
    test("should register listener for onBundleUninstalled event", () => {
      ...
      assert.ok(
        onBundleUninstalledCallback,
        "Should have callback for onBundleUninstalled",
      );
    });
    ...
    test("should register listener for onBundleUpdated event", () => {
      ...
      assert.ok(
        ...
        "Should have callback for onBundleUpdated",
      );
    });
  });
