...
suite("TemplateEngine", () => {
  ...
  suite("loadManifest", () => {
    ...
    test("should load template metadata", async () => {
      const manifest = await templateEngine.loadManifest();
      assert.ok(
        manifest.templates["example-prompt"],
        "Should have example-prompt template",
      );
  ...
  suite("renderTemplate", () => {
    ...
    test("should substitute variables in template", async () => {
      ...
      assert.ok(
        content.includes("my-collection"),
        "Should substitute collectionId",
      );
      assert.ok(
  ...
  suite("scaffoldProject", () => {
    ...
    test("should create all template files", async () => {
      ...
      assert.ok(
        fs.existsSync(
          path.join(tempDir, "instructions/example.instructions.md"),
        ),
      ...
      assert.ok(
        fs.existsSync(path.join(tempDir, "README.md")),
      ...
      assert.ok(
        fs.existsSync(path.join(tempDir, "scripts/README.md")),
        "Should create scripts README",
      );
  ...
  suite("getTemplates", () => {
    ...
    test("should include template metadata", async () => {
      ...
      assert.ok(
        Array.isArray(examplePrompt.variables),
