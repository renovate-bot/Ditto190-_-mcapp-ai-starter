...
suite("ScopeServiceFactory", () => {
  ...
  suite("create()", () => {
    test("should return UserScopeService for user scope", () => {
      ...
      // Act
      const service = ScopeServiceFactory.create(
        scope,
        mockContext,
        workspaceRoot,
        mockStorage,
      ...
      assert.ok(
        service instanceof UserScopeService,
        "Should return UserScopeService instance",
      );
    });
    ...
    test("should return UserScopeService for workspace scope", () => {
      ...
      assert.ok(
        service instanceof UserScopeService,
        "Should return UserScopeService instance for workspace scope",
      );
    });
    ...
    test("should return RepositoryScopeService for repository scope", () => {
      ...
      assert.ok(service, "Service should be created");
      assert.ok(
        service instanceof RepositoryScopeService,
        "Should return RepositoryScopeService instance",
      );
    });
  ...
  suite("Scope type mapping", () => {
    test("should map all valid InstallationScope values", () => {
      // Arrange
      const validScopes: InstallationScope[] = [
        "user",
        "workspace",
        "repository",
      ];
