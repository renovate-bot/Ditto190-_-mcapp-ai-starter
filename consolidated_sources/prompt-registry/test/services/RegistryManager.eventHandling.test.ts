  ...
  suite("onBundleInstalled Event", () => {
    test("should fire onBundleInstalled event with correct installation details", () => {
      ...
      assert.strictEqual(
        eventFired,
        true,
        "onBundleInstalled event should be fired",
      );
      ...
      assert.strictEqual(
        eventData?.version,
        "1.0.0",
        "Event should contain correct version",
      );
      assert.strictEqual(
        eventData?.sourceId,
        "test-source",
  ...
  suite("onBundleUninstalled Event", () => {
    test("should fire onBundleUninstalled event with correct bundle ID", () => {
      ...
      assert.strictEqual(
        eventFired,
        true,
        "onBundleUninstalled event should be fired",
      );
      assert.strictEqual(
        eventBundleId,
        "test-bundle-v1.0.0",
  ...
  suite("onBundleUpdated Event", () => {
    test("should fire onBundleUpdated event with correct new installation details", () => {
      ...
      assert.strictEqual(
        eventFired,
        true,
        "onBundleUpdated event should be fired",
      );
      assert.ok(eventData, "Event data should be provided");
      assert.strictEqual(
        eventData?.bundleId,
  ...
  suite("onSourceSynced Event", () => {
    test("should fire onSourceSynced event with correct source ID and bundle count", () => {
      ...
      assert.strictEqual(
        eventFired,
        true,
        "onSourceSynced event should be fired",
      );
      assert.ok(eventData, "Event data should be provided");
      assert.strictEqual(
        eventData?.sourceId,
    ...
    test("should fire onSourceSynced event with zero bundle count for empty sources", () => {
      ...
      assert.strictEqual(
        eventData?.bundleCount,
        0,
        "Event should contain zero bundle count",
      );
    });
  });
});
