  ...
  assets: [
    {
      ...
      browser_download_url:
        "https://github.com/microsoft/prompt-registry/releases/download/v2.1.0/olaf-linux-x64.tar.gz",
      size: 12345678,
    ...
    },
    {
      ...
      browser_download_url:
        "https://github.com/microsoft/prompt-registry/releases/download/v2.1.0/olaf-win32-x64.zip",
      size: 13456789,
    ...
    },
    {
      ...
      browser_download_url:
        "https://github.com/microsoft/prompt-registry/releases/download/v2.1.0/olaf-darwin-x64.tar.gz",
      size: 12789456,
      content_type: "application/gzip",
    },
  ],
    ...
    assets: [
      {
        name: "olaf-linux-x64.tar.gz",
        browser_download_url:
          "https://github.com/microsoft/prompt-registry/releases/download/v2.0.1/olaf-linux-x64.tar.gz",
        size: 12000000,
        content_type: "application/gzip",
      },
    ],
  ...
  assets: [
    {
      ...
      browser_download_url:
        "https://github.com/microsoft/prompt-registry/releases/download/v2.2.0-beta.1/olaf-linux-x64-beta.tar.gz",
      size: 13000000,
      content_type: "application/gzip",
    },
  ],
