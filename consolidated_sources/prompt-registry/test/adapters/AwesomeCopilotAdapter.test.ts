  ...
  suite("fetchBundles", () => {
    test("should fetch collections from repository", async () => {
      ...
      nock("https://raw.githubusercontent.com")
        .get(
          "/test-owner/awesome-copilot/main/collections/test-collection.collection.yml",
        )
        .reply(
          200,
          `
...
`,
    ...
    test("should skip invalid YAML files", async () => {
      ...
      nock("https://raw.githubusercontent.com")
        .get(
          "/test-owner/awesome-copilot/main/collections/invalid.collection.yml",
        )
  ...
  suite("downloadBundle - Dynamic ZIP Creation", () => {
    test.skip("should create ZIP archive from collection items", async () => {
      ...
      nock("https://raw.githubusercontent.com")
        .get(
          "/test-owner/awesome-copilot/main/collections/test-bundle.collection.yml",
        )
        .reply(
          200,
          `
...
`,
    ...
    test.skip("should include deployment-manifest.yml in ZIP", async () => {
      ...
      nock("https://raw.githubusercontent.com")
        .get(
          "/test-owner/awesome-copilot/main/collections/manifest-test.collection.yml",
        )
        .reply(
          200,
          `
...
`,
    ...
    test.skip("should handle missing prompt files gracefully", async () => {
      ...
      nock("https://raw.githubusercontent.com")
        .get(
          "/test-owner/awesome-copilot/main/collections/missing-files.collection.yml",
        )
        .reply(
          200,
          `
...
`,
  ...
  suite("Content Type Mapping", () => {
    test("should map .prompt.md files to prompt type", async () => {
      ...
      nock("https://raw.githubusercontent.com")
        .get(
          "/test-owner/awesome-copilot/main/collections/types.collection.yml",
        )
        .reply(
          200,
          `
...
suite("Skill Kind Support", () => {
  test("should parse collection with skill items", async () => {
    ...
    nock("https://raw.githubusercontent.com")
      .get(
        "/test-owner/awesome-copilot/main/collections/skills-collection.collection.yml",
      )
      .reply(
        200,
        `
...
`,
  ...
  test("should fetch entire skill directory when downloading bundle with skills", async () => {
    ...
    nock("https://raw.githubusercontent.com")
      .get(
        "/test-owner/awesome-copilot/main/collections/skill-bundle.collection.yml",
      )
      .reply(
        200,
        `
...
`,
    ...
    nock("https://api.github.com")
      .get(
        "/repos/test-owner/awesome-copilot/contents/skills/my-skill?ref=main",
      )
      .reply(200, [
    ...
    nock("https://api.github.com")
      .get(
        "/repos/test-owner/awesome-copilot/contents/skills/my-skill/data?ref=main",
      )
      .reply(200, [
        {
          name: "config.json",
          path: "skills/my-skill/data/config.json",
          type: "file",
        },
      ]);
...
suite("AwesomeCopilotAdapter HTTP Redirect Handling", () => {
  ...
  test("should follow HTTP 301 redirects when fetching collections", async () => {
    ...
    nock("https://api.github.com")
      ...
      .reply(301, "", {
        location:
          "https://api.github.com/repos/new-owner/new-repo/contents/collections?ref=main",
      });
      ...
      .reply(200, [
        {
          ...
          type: "file",
          download_url:
            "https://raw.githubusercontent.com/new-owner/new-repo/main/collections/redirect-test.collection.yml",
        },
      ]);
    ...
    nock("https://raw.githubusercontent.com")
      .get(
        "/test-owner/awesome-copilot/main/collections/redirect-test.collection.yml",
      )
      .reply(301, "", {
        location:
          "https://raw.githubusercontent.com/new-owner/new-repo/main/collections/redirect-test.collection.yml",
...
`,
  ...
  test("should follow HTTP 302 redirects when validating repository", async () => {
    ...
    nock("https://api.github.com")
      ...
      .reply(302, "", {
        location:
          "https://api.github.com/repos/test-owner/awesome-copilot-v2/contents/collections?ref=main",
      });

    nock("https://api.github.com")
      .get("/repos/test-owner/awesome-copilot-v2/contents/collections?ref=main")
      .reply(200, [{ name: "test.collection.yml", type: "file" }]);
