  ...
  suite("fetchBundles()", () => {
    ...
    test("should include nested files when hashing remote skills", async () => {
      const mockNestedSkill = (assetSha: string) => {
          ...
          .reply(200, [
            {
              ...
              type: "file",
              download_url:
                "https://raw.githubusercontent.com/test-owner/test-skills-repo/main/skills/deep-skill/SKILL.md",
              sha: "sha-skill",
            },
            {
              name: "assets",
        ...
        nock("https://api.github.com")
          .get(
            "/repos/test-owner/test-skills-repo/contents/skills/deep-skill/assets",
          )
          .reply(200, [
            {
              name: "diagram.png",
              ...
              type: "file",
              download_url:
                "https://raw.githubusercontent.com/test-owner/test-skills-repo/main/skills/deep-skill/assets/diagram.png",
              sha: assetSha,
            },
          ]);
      ...
      assert.ok(
        versionWithUpdatedAsset.startsWith("hash:"),
        "Version should be hash-based",
      );
    });
    ...
    test("should skip directories without SKILL.md", async () => {
      ...
      nock("https://api.github.com")
        ...
        .reply(200, [
          {
            name: "README.md",
            path: "skills/invalid-skill/README.md",
            type: "file",
          },
        ]);
