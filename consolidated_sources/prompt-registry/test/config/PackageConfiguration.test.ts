  ...
  suite("Configuration Schema Structure", () => {
    test("should prefer workspace extension host for remote environments", () => {
      assert.ok(
        ...
        "package.json should define extensionKind array",
      );
      assert.ok(
      ...
      assert.ok(
        packageJson.extensionKind.includes("ui"),
        "extensionKind should include ui fallback",
      );
      assert.strictEqual(
    ...
    test("should have configuration section", () => {
      assert.ok(
        ...
        "package.json should have contributes section",
      );
      assert.ok(
    ...
    test("should have updateCheck.enabled setting", () => {
      ...
      assert.ok(
        setting.description,
        "updateCheck.enabled should have description",
      );
    });
    ...
    test("should have updateCheck.frequency setting", () => {
      ...
      assert.ok(
        setting.description,
        "updateCheck.frequency should have description",
      );
    });
    ...
    test("should have updateCheck.notificationPreference setting", () => {
      ...
      assert.ok(
        setting,
        "updateCheck.notificationPreference setting should exist",
      );
      assert.strictEqual(
        setting.type,
        "string",
    ...
    test("should have updateCheck.autoUpdate setting", () => {
      ...
      assert.ok(
        setting.description,
        "updateCheck.autoUpdate should have description",
      );
    });
  });
  ...
  suite("Default Values", () => {
    test("updateCheck.enabled should default to true", () => {
      ...
      assert.strictEqual(
        setting.default,
        true,
        "updateCheck.enabled should default to true",
      );
    });
  ...
  suite("Enum Options", () => {
    test("updateCheck.frequency should have correct enum values", () => {
      ...
      assert.ok(
        ...
        "updateCheck.frequency should have enum array",
      );
      assert.strictEqual(
        setting.enum.length,
        3,
      ...
      assert.ok(
        setting.enum.includes("weekly"),
        'enum should include "weekly"',
      );
      assert.ok(
        setting.enum.includes("manual"),
        'enum should include "manual"',
      );
    });
    ...
    test("updateCheck.notificationPreference should have correct enum values", () => {
      ...
      assert.ok(
        setting.enum.includes("critical"),
        'enum should include "critical"',
      );
