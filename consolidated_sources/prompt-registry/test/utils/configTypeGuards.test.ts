...
suite("configTypeGuards", () => {
  ...
  suite("getValidUpdateCheckFrequency()", () => {
    ...
    test("should use custom default when provided", () => {
      assert.strictEqual(
        getValidUpdateCheckFrequency("invalid", "weekly"),
        "weekly",
      );
      assert.strictEqual(
        getValidUpdateCheckFrequency(null, "manual"),
        "manual",
      );
    });
  });
  ...
  suite("getValidNotificationPreference()", () => {
    test("should return valid preference unchanged", () => {
      ...
      assert.strictEqual(
        getValidNotificationPreference("critical"),
        "critical",
      );
    ...
    test("should use custom default when provided", () => {
      assert.strictEqual(
        getValidNotificationPreference("invalid", "critical"),
        "critical",
      );
