...
suite("copilotFileTypeUtils", () => {
  ...
  suite("determineFileType", () => {
    suite("detection from file name", () => {
      ...
      test("should detect instructions type from .instructions.md extension", () => {
        assert.strictEqual(
          determineFileType("coding-standards.instructions.md"),
          "instructions",
        );
        assert.strictEqual(
          determineFileType("test.instructions.md"),
          "instructions",
        );
      });
      ...
      test("should detect agent type from .agent.md extension", () => {
        assert.strictEqual(
          determineFileType("code-reviewer.agent.md"),
          "agent",
        );
      ...
      test('should detect instructions from filename containing "instructions"', () => {
        assert.strictEqual(
          determineFileType("my-instructions.md"),
          "instructions",
        );
        assert.strictEqual(
          determineFileType("coding_instructions.md"),
          "instructions",
        );
      });
    ...
    suite("detection from tags", () => {
      test("should detect instructions type from tags", () => {
        assert.strictEqual(
          determineFileType("file.md", ["instructions"]),
          "instructions",
        );
        assert.strictEqual(
          determineFileType("file.md", ["other", "instructions"]),
          "instructions",
        );
      });
      ...
      test("should detect chatmode type from tags", () => {
        assert.strictEqual(
          determineFileType("file.md", ["chatmode"]),
          "chatmode",
        );
      ...
      test("should prioritize file extension over tags", () => {
        ...
        assert.strictEqual(
          determineFileType("test.agent.md", ["instructions"]),
          "agent",
        );
        assert.strictEqual(
          determineFileType("test.instructions.md", ["agent"]),
          "instructions",
        );
      });
      ...
      test("should use tags when file extension is generic", () => {
        ...
        assert.strictEqual(
          determineFileType("generic.md", ["chatmode"]),
          "chatmode",
        );
      });
    });
    ...
    suite("edge cases", () => {
      ...
      test("should handle paths with directories", () => {
        assert.strictEqual(
          determineFileType("prompts/my-prompt.prompt.md"),
          "prompt",
        );
        assert.strictEqual(
          determineFileType("agents/code-reviewer.agent.md"),
          "agent",
        );
      });
    });
  ...
  suite("getTargetFileName", () => {
    test("should generate prompt file name", () => {
      assert.strictEqual(
        getTargetFileName("my-prompt", "prompt"),
        "my-prompt.prompt.md",
      );
    });
    ...
    test("should generate instructions file name", () => {
      assert.strictEqual(
        getTargetFileName("coding-standards", "instructions"),
    ...
    test("should generate chatmode file name", () => {
      assert.strictEqual(
        getTargetFileName("expert-mode", "chatmode"),
        "expert-mode.chatmode.md",
      );
    });

    test("should generate agent file name", () => {
      assert.strictEqual(
        getTargetFileName("code-reviewer", "agent"),
    ...
    test("should handle IDs with special characters", () => {
      assert.strictEqual(
        getTargetFileName("my_prompt-v1", "prompt"),
        "my_prompt-v1.prompt.md",
      );
    });
  });
  ...
  suite("getRepositoryTargetDirectory", () => {
    test("should return .github/prompts/ for prompt type", () => {
      assert.strictEqual(
        getRepositoryTargetDirectory("prompt"),
        ".github/prompts/",
      );
    });
    ...
    test("should return .github/instructions/ for instructions type", () => {
      assert.strictEqual(
        getRepositoryTargetDirectory("instructions"),
        ".github/instructions/",
      );
    });
    ...
    test("should return .github/prompts/ for chatmode type", () => {
      ...
      assert.strictEqual(
        getRepositoryTargetDirectory("chatmode"),
        ".github/prompts/",
      );
    });
    ...
    test("should return .github/agents/ for agent type", () => {
      assert.strictEqual(
        getRepositoryTargetDirectory("agent"),
        ".github/agents/",
      );
    });
    ...
    test("should return paths starting with .github/", () => {
      ...
      for (const type of types) {
        ...
        assert.ok(
          ...
          `Directory for ${type} should start with .github/`,
        );
      }
    });
  });
  ...
  suite("isSkillDirectory", () => {
    ...
    test("should return true for nested skills paths", () => {
      ...
      assert.strictEqual(
        isSkillDirectory("bundles/test/skills/skill-name"),
        true,
      );
    });
    ...
    test("should return false for non-skill paths", () => {
      assert.strictEqual(
        isSkillDirectory("prompts/my-prompt.prompt.md"),
        false,
      );
  ...
  suite("getSkillName", () => {
    ...
    test("should extract skill name from nested path", () => {
      ...
      assert.strictEqual(
        getSkillName("bundles/test/skills/skill-name"),
        "skill-name",
      );
    });
    ...
    test("should extract skill name from path with trailing content", () => {
      ...
      assert.strictEqual(
        getSkillName("skills/my-skill/src/index.js"),
        "my-skill",
      );
    });
    ...
    test("should handle Windows-style paths", () => {
      assert.strictEqual(getSkillName("skills\\my-skill"), "my-skill");
      assert.strictEqual(
        getSkillName("path\\to\\skills\\my-skill"),
        "my-skill",
      );
    });
